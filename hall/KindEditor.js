...
var KE_IMAGE_UPLOAD_CGI = "/trades/upfile.asp";
...
function KindDrawMedia(cmd)
{
	...
	ks.append(cmd, 'link" value="http://www.szaw.gov.cn/" style="width:190px;border:1px solid #555555;" /></td></tr>');
	...
	switch (cmd)
	{
		...
		case 'KE_ABOUT':
			...
			str += '<span style="margin-right:10px;">KindEditor ' + KE_VERSION + '</span>' + 
				'<a href="http://#/" target="_blank" style="color:#4169e1;" onclick="javascript:KindDisableMenu();">'+KE_LANG['ABOUT']+'</a><br />';
			str += '</div>';
			return str;
			break;
		default: 
...
function KindDrawIframe(cmd)
{
	switch (cmd)
	{
		...
		case 'KE_FLASH':
			...
			'<td style="width:210px;padding-bottom:5px;"><input type="text" id="flashLink" value="http://www.szaw.gov.cn/" style="width:190px;border:1px solid #555555;" /></td></tr>' +
